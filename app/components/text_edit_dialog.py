...
def text_input_field(
    ...
    return rx.el.div(
        ...
        rx.el.input(
            ...
            class_name="w-full p-3 bg-gray-800 border-2 border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-[#00d4ff] focus:border-[#00d4ff] focus:ring-2 transition-all",
        ),
        class_name="w-full",
    )
